...
type V3CcssCounterOrderCloseRequest struct {
	V3Common
...
func (r *V3CcssCounterOrderCloseRequest) ToBody() (string, error) {
	return r.BuildBody(r)
}

func (r *V3CcssCounterOrderCloseRequest) FunctionCode() enums.FunctionCode {
	return enums.API_V3_CCSS_COUNTER_ORDER_CLOSE
}
