...
type V3LabsRelationIdmrefundRequest struct {
	V3Common
...
func (r *V3LabsRelationIdmrefundRequest) ToBody() (string, error) {
	return r.BuildBody(r)
}

func (r *V3LabsRelationIdmrefundRequest) FunctionCode() enums.FunctionCode {
	return enums.API_V3_LABS_RELATION_IDMREFUND
}
