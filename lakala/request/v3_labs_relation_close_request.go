...
type V3LabsRelationCloseRequest struct {
	V3Common
...
func (r *V3LabsRelationCloseRequest) ToBody() (string, error) {
	return r.BuildBody(r)
}

func (r *V3LabsRelationCloseRequest) FunctionCode() enums.FunctionCode {
	return enums.API_V3_LABS_RELATION_CLOSE
}
