...
type V3IpsdfPaidBatchQueryRequest struct {
	V3Common
...
func (r *V3IpsdfPaidBatchQueryRequest) ToBody() (string, error) {
	return r.BuildBody(r)
}

func (r *V3IpsdfPaidBatchQueryRequest) FunctionCode() enums.FunctionCode {
	return enums.API_V3_IPSDF_PAID_BATCHQUERY
}
